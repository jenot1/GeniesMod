...
import net.jenot.genies.integration.GemCuttingStationRecipeCategory;
...
@JeiPlugin
public class JEIGeniesPlugin implements IModPlugin {
    @Override
    public ResourceLocation getPluginUid() {
        return new ResourceLocation(Genies.MOD_ID, "jei_plugin");
    }
