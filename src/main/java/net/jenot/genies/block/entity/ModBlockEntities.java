package net.jenot.genies.block.entity;

import net.jenot.genies.Genies;
import net.jenot.genies.block.ModBlocks;
import net.jenot.genies.block.entity.custom.GemCuttingStationBlockEntity;
import net.jenot.genies.block.entity.custom.ModSignBlockEntity;
...
public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITIES, Genies.MOD_ID);
